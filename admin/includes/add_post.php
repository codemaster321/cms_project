<?php
  ...
  if(isset($_POST['create_post']))
  {
    ...
    echo "<p class='bg-success'>Post Created Successfully  <a href='posts.php'>View Post</a> </p>";
...
<form class="" action="" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <textarea name="post_content" class="form-control" id="body" rows="10" cols="30" ></textarea>
